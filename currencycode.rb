...
# elsif c == "E" && y == "M"
#   puts "#{r} is equivalent to #{r*20.97} MEXICAN PESS"
# elsif c == "E" && y == "B"
#   puts "#{r} is equivalent to #{r*0.83} BRITISH POUNDS"
# elsif c =="E" && y == "J"
#   puts "#{r} is equivalent to #{r*113.61} JAPANESE YENS"
#
# elsif c == "D" && y == "J"
...
class Currency
  ...
  attr_reader :eur,:usd,:jap,:mex,:gbp
  def initialize(eur:,usd:,jap:,mex:,gbp:)
  @eur= "€"
  @usd = "$"
  @mex = "$"
  @gbp= "£"
  ...
  puts 'what currencies would you like to converges'
end
